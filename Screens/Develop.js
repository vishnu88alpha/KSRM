...
const ResultsScreen = () => {
  ...
  const handleSemesterPress = (semester) => {
    ...
    const subjects = [
      { id: '1', subject: 'Data Structures', internalMarks, externalMarks, credits: (externalMarks + internalMarks < 44 ? 0 : 3), passFail: 'P' },
      { id: '2', subject: 'Algorithms', internalMarks, externalMarks, credits: (externalMarks + internalMarks < 44 ? 0 : 3), passFail: 'P' },
      { id: '3', subject: 'Database Management', internalMarks, externalMarks, credits: (externalMarks + internalMarks < 44 ? 0 : 3), passFail: 'P' },
      { id: '4', subject: 'Operating Systems', internalMarks, externalMarks, credits: (externalMarks + internalMarks < 44 ? 0 : 3), passFail: 'P' },
      { id: '5', subject: 'Computer Networks', internalMarks, externalMarks, credits: (externalMarks + internalMarks < 44 ? 0 : 3), passFail: 'P' },
      { id: '6', subject: 'Software Engineering', internalMarks, externalMarks, credits: (externalMarks + internalMarks < 44 ? 0 : 3), passFail: 'P' },
    ];

    // Randomly select one subject to fail
    const randomIndex = Math.floor(Math.random() * subjects.length);
    subjects[randomIndex].passFail = 'F';

    setSemesterData(subjects);
